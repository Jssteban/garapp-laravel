...
class UsuariosModel extends Model
{
    ...
    protected $fillable = ['nombre','apellido','numero_de_telefono','email','numero_de_cedula','direccion','password','url_imagen','descripcion','genero'];// poner los campos que se van a rellenar
