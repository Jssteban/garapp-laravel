...
Route::get('/api/productos', [ProducController::class, 'index']); // ruta principal de productos traer una lista de productos
Route::post('/api/productos', [ProducController::class, 'store']); // ruta de almacenaje de los productos o crear
Route::get('/api/productos/{id}', [ProducController::class, 'show']); // ruta que trae un producto en especifico 
Route::patch('/api/productos/{id}', [ProducController::class, 'update']); // ruta que actualiza el producto
Route::delete('/api/productos/{id}', [ProducController::class, 'destroy']); // ruta que borra el producto
